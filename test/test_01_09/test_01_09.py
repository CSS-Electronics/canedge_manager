...
class Test_01_09(TestMigrate):
    ...
    @pytest.mark.parametrize("type, fw_pack_pre, fw_pack_post, cfg_pre, cfg_post, cfg_func_name",
        [
            ...
            "fw/ce1-01.08.01.zip",
            "fw/ce1-01.09.01.zip",
            "test_01_09/ce1-01.08-default.json",
            "test_01_09/ce1-01.09-default.json",
            "config.config_func_01_08_XX_01_09_XX"
            ),
            # CANedge 1 GNSS
            # Default to default
            (CANedgeType.CANEDGE1G,
             "fw/ce1g-01.08.01.zip",
             "fw/ce1g-01.09.01.zip",
             "test_01_09/ce1g-01.08-default.json",
             "test_01_09/ce1g-01.09-default.json",
             "config.config_func_01_08_XX_01_09_XX"
             ),
            # CANedge 2
            # Default to default
            (CANedgeType.CANEDGE2,
             "fw/ce2-01.08.01.zip",
             "fw/ce2-01.09.01.zip",
             "test_01_09/ce2-01.08-default.json",
             "test_01_09/ce2-01.09-default.json",
             "config.config_func_01_08_XX_01_09_XX"
             ),
            # CANedge 2 GNSS
            # Default to default
            (CANedgeType.CANEDGE2G,
             ...
             "fw/ce2g-01.09.01.zip",
             "test_01_09/ce2g-01.08-default.json",
             "test_01_09/ce2g-01.09-default.json",
             "config.config_func_01_08_XX_01_09_XX"
             ),
            # CANedge 3 GNSS
            # Default to default
            (CANedgeType.CANEDGE3G,
             ...
             "fw/ce3g-01.09.01.zip",
             "test_01_09/ce3g-01.08-default.json",
             "test_01_09/ce3g-01.09-default.json",
             "config.config_func_01_08_XX_01_09_XX"
             ),
            # CANedge 1
            # Heartbeat enabled
            (CANedgeType.CANEDGE1,
             "fw/ce1-01.08.01.zip",
             "fw/ce1-01.09.01.zip",
             "test_01_09/ce1-01.08-heartbeat-enabled.json",
             "test_01_09/ce1-01.09-heartbeat-enabled.json",
             "config.config_func_01_08_XX_01_09_XX"
             ),
        ])
